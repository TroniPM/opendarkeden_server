...
ProfileSampleManager::~ProfileSampleManager()
{
	map<int, ProfileSampleSet*>::iterator itr = m_ProfileSampleMap.begin();
...
{
	map<int, ProfileSampleSet*>::iterator itr = m_ProfileSampleMap.find(TID);
...
{
	map<int, ProfileSampleSet*>::iterator itr = m_ProfileSampleMap.find(Thread::self());
