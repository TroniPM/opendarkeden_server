...
public:
	// 아이템의 속성에 미치는 영향
	int		getDurabilityOffset() const { return (getGrade()-4)*1000; }
	int		getDamageOffset() const { return (getGrade()-4); }
	int		getCriticalOffset() const { return (getGrade()-4)*2; }
};
...
public:
	// 아이템의 속성에 미치는 영향
	int		getDurabilityOffset() const { return (getGrade()-4)*DurabilityPitch; }
	int		getDefenseOffset() const { return (getGrade()-4)/DefenseGrade*DefensePitch; }
	int		getProtectionOffset() const { return (getGrade()-4)/ProtectionGrade*ProtectionPitch; }
};
...
public:
	// 아이템의 속성에 미치는 영향
	int		getDurabilityOffset() const { return (getGrade()-4)*1000; }
	Luck_t	getLuck() const { return (getGrade()-4); }
};
