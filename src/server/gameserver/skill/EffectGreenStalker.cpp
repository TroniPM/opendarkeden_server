	...
	throw(Error)
{
	...
	int PoisonDamage = computeMagicDamage(pCreature, m_Damage, SKILL_GREEN_STALKER, m_bVampire);

	// 무적상태 체크. by sigi. 2002.9.5
	if (!pCreature->isFlag(Effect::EFFECT_CLASS_NO_DAMAGE) && !pCreature->isFlag(Effect::EFFECT_CLASS_COMA))
	{
