	...
	throw(Error)
{
	...
	// �����濡�� ��ĥ �� �������� �����Ѵ�.
	int StormDamage = computeMagicDamage(pTargetCreature, m_Damage, SKILL_ACID_STORM, m_bVampire);
	...
	if (StormDamage > 0)
	{
		...
		pEffectStormAcid->setDeadline(16); // �̺κ� �ٲ��� �Ѵ�.
		pEffectStormAcid->setTick(5);             // �̺κе� �ٲ��� �Ѵ�.
