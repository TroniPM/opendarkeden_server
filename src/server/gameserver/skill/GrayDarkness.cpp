...
/*			// Wisdom of GrayDarkness �� �ִٸ� ���ӽð� 30% ����
			...
			// Wide GrayDarkness �� �ִٸ� ����� 5*5 �� ���. skill type � ����Ѵ�.
...
//							pEffect->affectObject(pTarget, false);
			...
			// watcherList���� cList�� ������ �ʰ�, caster(pVampire)�� �� �� ���� ������
			// OK4�� ������.. cList�� �߰��Ѵ�.
			for(list<Creature*>::const_iterator itr = watcherList.begin(); itr != watcherList.end(); itr++)
			{
				...
				if (bBelong == false && canSee(pWatcher, pVampire) == false)
				{
					...
					if (!pWatcher->isPC())
					{
						//cout << "GrayDarkness : ��ó ����Ʈ�� PC�� �ƴմϴ�." << endl;
...
//							pEffect->affectObject(pTarget, false);
			...
			// watcherList���� cList�� ������ �ʰ�, caster(pMonster)�� �� �� ���� ������
			// OK4�� ������.. cList�� �߰��Ѵ�.
			for(list<Creature*>::const_iterator itr = watcherList.begin(); itr != watcherList.end(); itr++)
			{
				bool bBelong = false;
