	...
	throw(Error)
{
	...
	try 
	{
		...
		if (bTimeCheck && bRangeCheck && bHitRoll && bCanHit && bPK)
		{
			...
			decreaseDurability(pOusters, pTargetCreature, 1, &_GCAttackMeleeOK1, &_GCAttackMeleeOK2);
