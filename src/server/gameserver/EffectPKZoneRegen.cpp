	...
	throw(Error)
{
	...
	if ( m_bSlayer && pCreature->isSlayer() )
	{
		...
		// HPï¿½ï¿½ ï¿½ï¿½ Ä¡ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½Â°ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½É·ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
...
//				GCModifyInformation gcMI;
	...
	else if ( m_bVampire && pCreature->isVampire() )
	{
		...
		if ( pVampire->getHP( ATTR_MAX ) > pVampire->getHP( ATTR_CURRENT ) )
		{
			...
			// ï¿½Ú±ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½Ù²ï¿½
			GCModifyInformation gcMI;
			gcMI.addShortData( MODIFY_CURRENT_HP, pVampire->getHP( ATTR_CURRENT ) );

			// HPï¿½ï¿½ ï¿½Ç¹ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½Ñ¾î¼­ï¿½ï¿½ ï¿½Ç¸ï¿½ ï¿½Ç¹íº–íµ¹ï¿½ï¿½ï¿½ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ ï¿½Ø´ï¿½.
	...
	throw(Error)
{
	...
	filelog( "PKZone.txt", "EffectPKZoneRegen[%d|(%d,%d,%d,%d)] ï¿½ï¿½ï¿½ï¿½Æ®ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½.",
