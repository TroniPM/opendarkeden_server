...
int OptionInfoManager::getRareUpgradeRatio( OptionType_t optionType, bool success )
{
	...
	if ( pOI == NULL ) throw Error("OptionInfoManager::getRareUpgradeRatio() : �ɼ� ������ ����ϴ�.");

	OptionClassInfo* pOCI = m_OptionClassInfos[pOI->getClass()];
	if ( pOCI == NULL ) throw Error("OptionInfoManager::getRareUpgradeRatio() : �ɼ� Ŭ���� ������ ����ϴ�.");

	RareOptionUpgradeInfo* pROUI = m_RareEnchantInfo[pOCI->getKey()];
	if ( pROUI == NULL ) throw Error("OptionInfoManager::getRareUpgradeRatio() : ���� ��æƮ ������ ����ϴ�.");
